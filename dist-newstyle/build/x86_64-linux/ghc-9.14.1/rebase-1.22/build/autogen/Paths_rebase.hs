...
-- at runtime using the environment variable rebase_bindir.
...
-- environment variable rebase_libdir.
...
-- using the environment variable rebase_dynlibdir.
...
-- runtime using the environment variable rebase_datadir.
...
-- using the environment variable rebase_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3/rebase-1.22-inplace"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.14.1-c6c3/rebase-1.22"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.14.1-c6c3/rebase-1.22"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "rebase_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "rebase_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "rebase_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "rebase_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "rebase_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "rebase_sysconfdir") (\_ -> return sysconfdir)
